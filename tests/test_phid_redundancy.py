...
def test_mmi_matches_previous_product_lattice_values():
    # Independently evaluated from the former MMI product-lattice algorithm.
    expected = torch.tensor(
        [
            0.001805626776189453,
            0.0,
            0.005444158071368070,
            0.039304917348183185,
            0.005444158071368070,
            0.060780989940456680,
            -0.005444158071368069,
            -0.037982556720401336,
            0.0,
            0.0,
            0.039304917348183160,
            -0.039304917348183160,
            0.042386286922428795,
            -0.042366013246665600,
            -0.039304917348183160,
            0.082782318822364070,
        ],
        dtype=torch.float64,
    )
